 ...
 */
final class Simple_Circuit_Breaker_Factory implements Factory_Interface
{
    /**
     * {@inheritdoc}
     */
    public function create(Factory_Settings_Interface $settings): Circuit_Breaker_Interface
    {
        ...
        return new Simple_Circuit_Breaker($open_place, $half_open_place, $closed_place, $client);
    }
}